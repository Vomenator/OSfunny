...
kernel.bin: $(OBJ_DIR)boot.o $(OBJ_DIR)kernel.o $(OBJ_DIR)command.o $(OBJ_DIR)screen.o $(OBJ_DIR)io.o
	$(LD) -m i386pe -T linker.ld -o $(BIN_DIR)kernel.bin $(OBJ_DIR)boot.o $(OBJ_DIR)kernel.o $(OBJ_DIR)command.o $(OBJ_DIR)screen.o $(OBJ_DIR)io.o
