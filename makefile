...
kernel.bin: $(OBJ_DIR)boot.o $(OBJ_DIR)kernel.o $(OBJ_DIR)commandPrompt.o $(OBJ_DIR)screen.o $(OBJ_DIR)input.o $(OBJ_DIR)string.o 
	$(LD) -m i386pe -T linker.ld -o $(OBJ_DIR)kernel.bin $(OBJ_DIR)boot.o $(OBJ_DIR)kernel.o $(OBJ_DIR)commandPrompt.o $(OBJ_DIR)screen.o $(OBJ_DIR)input.o $(OBJ_DIR)string.o
